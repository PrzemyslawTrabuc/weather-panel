...
const WeatherCard = (props: any) => {
  ...
  const handleMoveCardLeft = () => {
    setAnimate(false);
    setTimeout(() => setAnimate(true), 300);
    setTimeout(() => dispatch(moveFavCityLeftInArray({ cityIndexInArrayToChange: props.cityNumber, cityWeatherToUseAsTemp: props.weatherData, cityForecastToUseAsTemp: props.forecastData })), 300);
    setTimeout(() => dispatch(moveItemLeftInArray({ cityIndexInArrayToChange: props.cityNumber, cityWeatherToUseAsTemp: props.weatherData, cityForecastToUseAsTemp: props.forecastData })), 300);
    props.toggleTest();
  }
  ...
  const handleMoveCardRight = () => {
    setAnimate(false);
    setTimeout(() => setAnimate(true), 300);
    setTimeout(() => dispatch(moveFavCityRightInArray({ cityIndexInArrayToChange: props.cityNumber, cityWeatherToUseAsTemp: props.weatherData, cityForecastToUseAsTemp: props.forecastData })), 300);
    setTimeout(() => dispatch(moveItemRightInArray({ cityIndexInArrayToChange: props.cityNumber, cityWeatherToUseAsTemp: props.weatherData, cityForecastToUseAsTemp: props.forecastData })), 300);
    props.toggleTest();
  }
